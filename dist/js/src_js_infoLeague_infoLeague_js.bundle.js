...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async () => {
    fetch(url, {
        ...
        .then((value) => {
            ...
            // trier-na selon ny nom ana pays anle league 
            othersLeague.sort((a,b) => {
                console.log('a b');
                console.log(a.country_name, b.country_name);
                return a.country_name - b.country_name
            })
            // trier-na selon ny numero anle league
            leaguesPopular.sort((a,b) => a.number - b.number)
            // atambatra avy eo
            // console.log(othersLeague);
            // console.log(leaguesPopular);
